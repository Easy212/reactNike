...
function MainIndex(){
  const slideContent =[
    {id:1, img:"images/shoes-01.png", name:'나이키 데이브레이크', category:'여성신발 라이프스타일', price:'119,000원'},
    {id:2, img:'images/shoes-02.png', name:'나이키 에어맥스 97', category:'남성신발 라이프스타일', price:'199,000원'},
    {id:3, img:'images/shoes-03.png', name:'나이키 코드 레거시', category:'여성 뮬', price:'69,000원'},
    {id:4, img:'images/shoes-04.png', name:'나이키 리액트 인피니티 런 플라이니트 2', category:'여성신발 러닝', price:'179,000원'},
    {id:5, img:'images/shoes-05.png', name:'나이키 코믹스 유니티', category:'성인공용 신발 농구', price:'179,000원'} ,
    {id:6, img:'images/shoes-06.png', name:'나이키 에어 줌 빅토리 투어 2', category:'성인공용 신발 골프', price:'239,000원'},
    {id:7, img:'images/shoes-07.png', name:'나이키 에어 줌 슈퍼랩 2', category:'남성 신발 트레이닝', price:'139,000원'},
    {id:8, img:'images/shoes-08.png', name:'나이키 머큐리얼 드림 스피드 슈퍼플라이', category:'성인공용 신발 축구', price:'329,000원'}
  ]
    return(
    <section>
      <article className={styles.main_visual}>
        <div className={styles.main_img}>
          <img src="images/M-01.png" alt="크레이터 임펙트 이미지"/>
        </div>
        <div className={styles.main_text}>
          ...
          <div className={styles.btn_area}>
            <Link to="#" className={styles.btn_01}>구매하기</Link>
            <Link to="#" className={styles.btn_01}>자세히보기</Link>
          </div>
        </div>
      </article>
      ...
      <article className={styles.content}>
        ...
        <div className={styles.main_text}>
          ...
          <div className={styles.btn_area}>
            <Link to="#" className={styles.btn_01}>구매하기</Link>
            <Link to="#" className={styles.btn_01}>더 많은 스타일링 보기</Link>
          </div>
        </div>
      </article>
        ...
        <div className={styles.content_img}>
          <div className={styles.trend_img}>
            ...
            <div className={styles.trend_text}>
              ...
              <div className={styles.btn_area}>
                <Link to="#" className={`${styles.btn_01} ${styles.b_white}`}>구매하기</Link>
              </div>
            </div>
          </div>
          <div className={styles.trend_img}>
